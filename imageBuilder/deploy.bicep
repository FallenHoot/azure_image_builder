...
param stagingResourceGroupName string = 'rg-imagetemplates-staging'
...
@description('Optional. A function to customize your image')
...
module imageTemplate '../carml/0.10.0/modules/Microsoft.VirtualMachineImages/imageTemplates/deploy.bicep' = {
  scope: resourceGroup
